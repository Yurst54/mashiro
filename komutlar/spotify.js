...
`)
            ...
            return message.channel.send(` **${user.tag}** kullanıcısı şuan <:spotify:619797840188669965>'dan şarkı dinlemiyor.`);
        }

    } else {
        return message.channel.send(`**${user.tag}** kullanıcısı hesabına <:spotify:619797840188669965>'ı eklememiş`);
    }
};
