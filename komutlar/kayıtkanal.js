...
exports.run = async (bot, message, args) => {
  ...
  if (!mentionedChannel && args[0] !== "kapat") return message.channel.send(`:x: | Kayıt Kanalını Ayarlamam Için Kanal Etiketlemelisin. Orn: \`+kayıtkanal #kanal\``);
...
exports.help = {
  ...
  category: 'Kayıt Sistemi',
    description: 'Kayıt kanal komutu!',
    usage: 'kayıtkanal'
}
