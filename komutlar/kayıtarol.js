...
exports.run = async (bot, message, args) =>
{
  ...
  if (message.guild.member(message.author.id).hasPermission(0x8))
    
    {
      ...
      if (!mentionedRole) return message.channel.sendMessage("Kayıt Rolu Ayarlamak Için Rol Etiketlemelisin. `+kayıtalınacakrol @rol`".then(msg => msg.delete(5000)));
...
exports.help = {
  ...
  category: 'Kayıt Sistemi',
    description: 'Kayıt olduktan sonra alınacak rolü ayarlarsın!',
    usage: 'kayıtarol'
}
