...
exports.run = (client, message, args) => {
  if (message.author.id != "452540880948035585") return message.reply('Bunu Sadece Sahibim Kullanabilir');
  ...
  .setColor('RANDOM')
  .setTitle(`<:emoji_1:647917884873637908>   **Sahibim Sana Mesaj Yolladı!** <:emoji_1:647917884873637908>  `)
  .setTimestamp()
