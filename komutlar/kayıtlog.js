...
exports.run = async (bot, message, args) => {
  ...
  if (!mentionedChannel && args[0] !== "sıfırla") return message.channel.send(`:x: Ayarlamam Için Log Kanalı Etiketlemelisin. Orn: \`+kayıtlog #logkanal\``);
