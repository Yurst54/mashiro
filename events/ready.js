...
//var oyun = [ 
  ...
  client.user.setGame(`!!goldy | Gold Yardim`, 'https://www.twitch.tv/'),
  client.user.setGame(`!!yardım | !!sunucutanıt`, "https://www.twitch.tv/"),
  client.user.setGame(client.guilds.reduce((a, b) => a + b.memberCount,  0).toLocaleString()+` Kullanıcı Ile`, "https://www.twitch.tv/")
// ] 
//client.user.setStatus("streaming")
 //// client.user.setGame(`!!yardım | Yardım Menusu`, "")
