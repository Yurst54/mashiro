...
module.exports = (client) => {
  ...
  app.get("/autherror", (req, res) => {
    ...
    client.channels.get('669591344465051698').send("Web Panelinde bağlantı hatası oluştu! Kişi giriş yapamıyor tekrar denemeli! Büyük bir sorun değil.")
  });
  ...
  app.get("/bot", (req, res) => {
    ...
    const channelss = client.channels.size;
    const guildss = client.guilds.size;
    const text = client.channels.filter(c => c.type === "text").size;
    const voice = client.channels.filter(c => c.type === "voice").size;
